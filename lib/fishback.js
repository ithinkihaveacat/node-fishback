...
["parseHeader", "wantsCache", "canCache", "onlyWantsCache", "isVaryMatch", "isFreshEnough", "expiresAt"].forEach(function (s) {
    exports[s] = eval(s); // UGH ... what's the equivalent of "window" in node??
});
