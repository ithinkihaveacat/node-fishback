...
function Proxy(cache)
{
    ...
    this.server = http.createServer((function(req1, res1) {
        ...
        // Add some properties to res2 to normalise
        ...
        var request = this.request(req1, t);

        var respondFromCache   = this.respondFromCache(res1, t);
        var respondFromEmitter = this.respondFromEmitter(res1, t);
