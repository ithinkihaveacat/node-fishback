...
Cache.prototype.clean = function()
{
    ...
    // Find the index of the oldest of three entries picked at random
    var index = [
...
//        console.log(cache.dumpList());
//        console.log(cache.dumpData());
    }
}
